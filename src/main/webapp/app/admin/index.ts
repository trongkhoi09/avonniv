export * from './area-management/area-management-dialog.component';
export * from './area-management/area-management-delete-dialog.component';
export * from './area-management/area-management.component';
export * from './area-management/area-management.route';
export * from './area-management/area-modal.service';
...
export * from './publisher-management/publisher-management-dialog.component';
export * from './publisher-management/publisher-management-delete-dialog.component';
export * from './publisher-management/publisher-management-detail.component';
export * from './publisher-management/publisher-management.component';
export * from './publisher-management/publisher-management.route';
export * from './publisher-management/publisher-modal.service';
